...
A strong choice is the recent Citation File Format~\cite{citation.cff} which is serialized as YAML in a \texttt{CITATION.cff}, as seen in~\Cref{lst:cation.cff}.
